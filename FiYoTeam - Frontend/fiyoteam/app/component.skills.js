System.register(['angular2/core', 'rxjs/Rx', './service.getandpost'], function(exports_1, context_1) {
    ...
    return {
        ...
        execute: function() {
            SkillTemplateComponent = (function () {
                function SkillTemplateComponent(getAndPostService) {
                    this.getAndPostService = getAndPostService;
                    this.newSkill = new service_getandpost_1.Skill(null, '', 50);
                }
                SkillTemplateComponent.prototype.ngOnInit = function () {
                    this.userId = localStorage.getItem("USERID");
                    this.getUserSkills();
                    this.getAvailableSkills();
                };
                SkillTemplateComponent.prototype.getUserSkills = function () {
                    var _this = this;
                ...
                SkillTemplateComponent.prototype.getAvailableSkills = function () {
                    var _this = this;
                ...
                SkillTemplateComponent.prototype.updateSkills = function () {
                    var _this = this;
                ...
                SkillTemplateComponent.prototype.addNewSkill = function () {
                    var _this = this;
                ...
                SkillTemplateComponent.prototype.deleteSkill = function (skill) {
                    var _this = this;
                ...
                SkillTemplateComponent = __decorate([
                    core_1.Component({
            ...
            exports_1("SkillTemplateComponent", SkillTemplateComponent);
        }
    }
});
//# sourceMappingURL=component.skills.js.map