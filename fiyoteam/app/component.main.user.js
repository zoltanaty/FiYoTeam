System.register(['angular2/core', './service.getandpost', 'angular2/router', 'rxjs/Rx', './component.userprofile', './component.users', './component.othersprofile', './component.findprojects', './component.homepage'], function(exports_1, context_1) {
    "use strict";
    ...
    var core_1, service_getandpost_1, router_1, component_userprofile_1, component_users_1, component_othersprofile_1, component_findprojects_1, component_homepage_1;
    ...
    return {
        setters:[
            ...
            function (component_homepage_1_1) {
                component_homepage_1 = component_homepage_1_1;
            }],
        execute: function() {
            MainUserComponent = (function () {
                ...
                MainUserComponent = __decorate([
                    core_1.Component({
                        ...
                        directives: [component_userprofile_1.UserProfileComponent, component_users_1.UsersComponent, component_othersprofile_1.OthersProfileComponent, component_findprojects_1.FindProjectsComponent, component_homepage_1.HomePageComponent],
